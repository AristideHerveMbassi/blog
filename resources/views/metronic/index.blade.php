...
<html lang="en">
	...
	<div class="kt-page-loader kt-page-loader--logo">
		...
		<script src="{{asset('assets/js/demo12/pages/crud/datatables/basic/basic.js')}}" type="text/javascript"></script>
