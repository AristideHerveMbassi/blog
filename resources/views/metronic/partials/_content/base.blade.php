...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	...
	<!--[html-partial:begin:{"id":"demo12/dist/inc/view/demos/pages/index","page":"index"}]/-->

	<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/dashboards/dashboard-1","page":"index"}]/-->
	...
	<div class="row">
		<div class="col-lg-6 col-xl-4 order-lg-1 order-xl-1">
			...
			<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/widgets/chart/activity","page":"index"}]/-->
				...
				<div class="kt-portlet__head kt-portlet__head--noborder kt-portlet__space-x">
					...
					<div class="kt-portlet__head-toolbar">
						...
						<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
							...
							<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/general/dropdown-menu-2","page":"index"}]/-->
							<ul class="kt-nav">
							...
							<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/general/dropdown-menu-2","page":"index"}]/-->
						</div>
					</div>
				</div>
			...
			<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/widgets/chart/activity","page":"index"}]/-->
		</div>
		<div class="col-lg-6 col-xl-4 order-lg-1 order-xl-1">

			<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/widgets/chart/inbound-bandwidth","page":"index"}]/-->
				...
				<div class="kt-portlet__head kt-portlet__space-x">
					...
					<div class="kt-portlet__head-toolbar">
						...
						<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
							...
							<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/general/dropdown-menu-1","page":"index"}]/-->
							<ul class="kt-nav">
								<li class="kt-nav__item">
									<a href="#" class="kt-nav__link">
							...
							<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/general/dropdown-menu-1","page":"index"}]/-->
						</div>
					</div>
				</div>
			...
			<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/widgets/chart/inbound-bandwidth","page":"index"}]/-->
			<div class="kt-space-20"></div>

			<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/widgets/chart/outbound-bandwidth","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/widgets/chart/outbound-bandwidth","page":"index"}]/-->
		</div>
		<div class="col-lg-6 col-xl-4 order-lg-1 order-xl-1">

			<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/widgets/general/recent-activities","page":"index"}]/-->
					...
					<div class="kt-portlet__head-toolbar">
						<div class="dropdown dropdown-inline">
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-menu-fit dropdown-menu-md">
								...
								<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/general/dropdown-menu-3","page":"index"}]/-->
								...
								<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/general/dropdown-menu-3","page":"index"}]/-->
							</div>
						</div>
					</div>
				</div>
			...
			<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/widgets/general/recent-activities","page":"index"}]/-->
		</div>
		<div class="col-xl-8 order-lg-2 order-xl-1">

			<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/widgets/list/latest-orders","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/widgets/list/latest-orders","page":"index"}]/-->
		</div>
		<div class="col-lg-6 col-xl-4 order-lg-1 order-xl-1">

			<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/widgets/general/blog","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/widgets/general/blog","page":"index"}]/-->
		</div>
	</div>
	...
	<div class="row">
		<div class="col-xl-8 col-lg-12 order-lg-3 order-xl-1">
			...
			<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/widgets/general/best-sellers","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/widgets/general/best-sellers","page":"index"}]/-->
		</div>
		<div class="col-xl-4 col-lg-6 order-lg-3 order-xl-1">

			<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/widgets/general/new-users","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/widgets/general/new-users","page":"index"}]/-->
		</div>
		<div class="col-xl-4 col-lg-4 order-lg-2 order-xl-1">

			<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/widgets/chart/mini-daily-sales","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/widgets/chart/mini-daily-sales","page":"index"}]/-->
		</div>
		<div class="col-xl-4 col-lg-4 order-lg-2 order-xl-1">

			<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/widgets/chart/mini-profit-share","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/widgets/chart/mini-profit-share","page":"index"}]/-->
		</div>
		<div class="col-xl-4 col-lg-4 order-lg-2 order-xl-1">

			<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/widgets/chart/mini-revenue-change","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/widgets/chart/mini-revenue-change","page":"index"}]/-->
		</div>
		<div class="col-xl-4 col-lg-6 order-lg-3 order-xl-1">

			<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/widgets/general/tasks","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/widgets/general/tasks","page":"index"}]/-->
		</div>
		<div class="col-xl-4 col-lg-6 order-lg-3 order-xl-1">

			<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/widgets/general/notifications","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/widgets/general/notifications","page":"index"}]/-->
		</div>
		<div class="col-xl-4 col-lg-6 order-lg-3 order-xl-1">

			<!--[html-partial:begin:{"id":"demo12/dist/inc/view/partials/content/widgets/general/support-tickets","page":"index"}]/-->
			...
			<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/widgets/general/support-tickets","page":"index"}]/-->
		</div>
	</div>
	...
	<!--[html-partial:end:{"id":"demo12/dist/inc/view/partials/content/dashboards/dashboard-1","page":"index"}]/-->

	<!--[html-partial:end:{"id":"demo12/dist/inc/view/demos/pages/index","page":"index"}]/-->
</div>
