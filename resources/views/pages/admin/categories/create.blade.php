...
@section('Meta')
    ...
    {!! OpenGraph::generate() !!}
@endsection
@section('subtitle') Catégories @endsection
@section('css')
                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                <div class="form-group">
                                    <label>Nom:</label>
                                    <input type="text" name="name" id="name" class="form-control" placeholder="nom catégorie">
                                    <span class="form-text text-muted">Entrez le nom de la catégorie s'il vous plait</span>
                                </div>
                                <div class="form-group">
                                    <label>Description:</label>
                                    <textarea type="textarea" name="description" id="description" class="form-control" placeholder="description catégorie"> </textarea>
            ...
            <div class="col-lg-12">
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <!--begin: Datatable -->
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="categorieTable">
                            <thead>
                            <tr>
